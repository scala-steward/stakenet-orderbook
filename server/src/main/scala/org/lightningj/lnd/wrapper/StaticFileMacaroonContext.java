...
public class StaticFileMacaroonContext implements MacaroonContext{
     ...
     * @throws RuntimeException if problem occurs during reading or parsing of macaroon data. status is null.
     */
    public StaticFileMacaroonContext(File macaroonPath) throws Exception{
        try {
            ...
            throw new RuntimeException("Error reading macaroon from path '" + macaroonPath + "', message: " + e.getMessage(), e);
        }
    }
