...
class TradePersisterActor(orderManager: OrderManagerActor.Ref, tradesRepository: TradesRepository.FutureImpl)(
  ...
  override def receive: Receive = {
    case peers.protocol.Event.ServerEvent.SwapSuccess(trade) =>
...
object TradePersisterActor {
  ...
  def props(orderManager: OrderManagerActor.Ref, tradesRepository: TradesRepository.FutureImpl)(
      implicit ec: ExecutionContext
