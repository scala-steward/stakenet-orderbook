...
-- !Ups
ALTER TYPE TRADING_PAIR ADD VALUE 'BTC_USDT';
ALTER TYPE CURRENCY_TYPE ADD VALUE 'USDT';

-- !Downs
ALTER TYPE TRADING_PAIR RENAME TO TRADING_PAIR_OLD;
CREATE TYPE TRADING_PAIR AS ENUM('XSN_BTC', 'XSN_LTC', 'LTC_BTC', 'XSN_WETH', 'BTC_WETH');
...
CREATE TYPE CURRENCY_TYPE AS ENUM('XSN', 'LTC', 'BTC', 'WETH');
...
ALTER TABLE channels DROP CONSTRAINT channel_channel_fee_payment_fk;
...
ALTER TABLE channels ALTER COLUMN paying_currency TYPE CURRENCY_TYPE USING paying_currency::text::CURRENCY_TYPE;
...
ALTER TABLE channel_rental_extension_fees ALTER COLUMN paying_currency TYPE CURRENCY_TYPE USING paying_currency::text::CURRENCY_TYPE;
ALTER TABLE channel_rental_extension_fees ALTER COLUMN rented_currency TYPE CURRENCY_TYPE USING rented_currency::text::CURRENCY_TYPE;
ALTER TABLE channel_rental_fee_details ALTER COLUMN currency TYPE CURRENCY_TYPE USING currency::text::CURRENCY_TYPE;
ALTER TABLE client_public_keys ALTER COLUMN currency TYPE CURRENCY_TYPE USING currency::text::CURRENCY_TYPE;
ALTER TABLE currency_prices ALTER COLUMN currency TYPE CURRENCY_TYPE USING currency::text::CURRENCY_TYPE;
